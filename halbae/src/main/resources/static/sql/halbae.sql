...
CREATE TABLE CLASS_LIST (
    ...
    CLASS_CATEGORY	VARCHAR(30),
    CLASS_AREA		VARCHAR(30),
    CLASS_TIME		VARCHAR(30),
    CLASS_MONEY		VARCHAR(30),
    CLASS_GRADE		DECIMAL(2,1),
...
CREATE TABLE COUPON (
    ...
    COUPON_ENDDATE		DATETIME 	  NOT NULL
);
